...
| Team Member     | Role                     | Deliverable| Description of Work                                              | Time Spent (hours)  |
|-----------------|--------------------------|------------|------------------------------------------------------------------|---------------------|
| Gracie Diabo    | Developer                | 3          | Development & Testing: Log In & Homepage, Update Header and Homepage, UI Design + Report            | 25                  |
| Janelle Tam     | Project Manager          | 3          | Development & Testing: New Review, Create Game Popup, Add Game Forms, View Games  | 26                  |
| Natasha Lawford | Developer                | 3          | Development & Testing: Event Creation, Event Registration, Unregister Event, UI Design + Report               | 25                  |
| Alison Quach    | Developer                | 3          | Development & Testing: Header, Event Creation, Event Creation form, Display Events + Report           | 25                  |
| Malak Oualid    | Senior Developer         | 3          | Development & Testing: View Games, Create Game Popup, Borrow Request Catalogue, Borrow Form    | 26                  |
| Jason Rustom    | Senior Developer         | 3          | Development & Testing: Local Storage, Account Details Update Login, Update Owned Games, Toggle Account, + Code Review | 25                  |
| Nathan Reid     | Developer                | 3          | Development & Testing: Account Details: Borrow Requests, Lending History, Event History, Owned Games + Report        | 25                  |
